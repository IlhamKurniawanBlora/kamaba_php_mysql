    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-slate-600 hover:underline">Beranda</a></li>
                    <li><a href="#about" class="text-slate-600 hover:underline">Tentang Kami</a></li>
                    <li><a href="#blogs" class="text-slate-600 hover:underline">Berita</a></li>
                    <li><a href="#events" class="text-slate-600 hover:underline">Acara</a></li>
                    <li><a href="#contact" class="text-slate-600 hover:underline">Kontak</a></li>
                </ul>
            </div>
            <div>
